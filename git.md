...
![image-20200731232217088](git.assets/image-20200731232217088.png)

选择回退的版本，当前提交的版本是HEAD，即webexcel

如果向回退到上一个版本，就是io版本，就选择HEAD^

如果会对到上上个版本，就是hashset版本，就选择HEAD^^，以此类推
...
![image-20200731232409798](git.assets/image-20200731232409798.png)
